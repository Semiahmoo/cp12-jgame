...
class JREImage implements JGImage {
	...
	* Throws JGError when there was an error. */
	...
	public JGImage createImageFromData(int imgwidth, int imgheight,
	...
	* why isn't there a built in method to do this? */
	...
	public static Image createScratchImage(int width, int height) {
		try {
			...
			if (valid == null || valid.intValue() == 2) { // I checked, IMAGE_INCOMPATIBLE=2
 ...
 */
	static Object tryMethod(Object o,String name,Object [] args) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
